<div class="navbar navbar-fixed-top navbar-inverse">
        <div class="navbar-inner">
            <div class="container-fluid">
                ...
                <a class="brand" href="#">Welcome to: BigSchool Management System</a>
						...
						<ul class="nav pull-right">
							...
							<li class="dropdown">
								<a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-user icon-large"></i><?php echo $row['firstname']." ".$row['lastname'];  ?> <i class="caret"></i></a>
                                    ...
                                    <li><a tabindex="-1" href="update_student_account.php"><i class="icon-circle"></i> Update Registration</a></li>
